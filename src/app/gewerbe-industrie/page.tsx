...
export const metadata: Metadata = {
  title: 'Gewerbe & Industrie (C&I) | Goldy Solar GmbH',
  description: 'Photovoltaik für Unternehmen: Industriehallen, Logistikzentren, Lastspitzenkappung und Gewerbespeicher.',
};
...
export default function CommercialPage() {
  return (
    <div>
      {/* 1. Page Hero Banner */}
      <PageHeroBanner
        category="GEWERBE & INDUSTRIE (C&I) • GROSSDACHANLAGEN"
        title="Photovoltaik & Speicher für Unternehmen"
        subtitle="Senken Sie Ihre betrieblichen Stromkosten, sichern Sie sich gegen Preisrisiken ab und optimieren Sie Ihre CO2-Bilanz."
        trustTags={['Peak Shaving & Gewerbespeicher', 'Amortisation 4–7 Jahre', 'VDE-AR-N 4110 Mittelspannung']}
      />
      ...
      <div className="container" style={{ paddingTop: '40px', paddingBottom: '80px', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ background: '#FFFFFF', padding: '40px 36px', borderRadius: '24px', border: '1px solid #E2E8F0', boxShadow: '0 6px 20px rgba(15, 71, 97, 0.05)', marginBottom: '50px' }}>
          <h2 style={{ fontSize: '26px', fontWeight: 900, color: '#0E2841', marginBottom: '16px' }}>
            Wirtschaftliche Solarlösungen für Gewerbe und Industrie
          </h2>
          ...
          <h3 style={{ fontSize: '20px', fontWeight: 800, color: '#0E2841', marginBottom: '14px' }}>
            Kernleistungen für Unternehmen:
          </h3>
